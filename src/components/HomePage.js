...
import Question_List_Page from './Question_List_Page'
...
const HomePage = () => {
    ...
    {/* <div className='img'>
        <img src={Bgimg} style={{ width:"60%",height:"55%"}}/>
    </div> */}
...
<div className="container" >
        <div className="row">
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gridGap: 10, marginLeft: "-10%"}}>
                ...
                <div><img src={GrowthLogo} style={{ width:"45%",height:"25%", marginTop: "10%", marginLeft:"34%"}}></img>
                ...
                <div><img src={SearchLogo} style={{  width:"48%",height:"25%", marginTop: "10%",marginLeft:"37%"}}></img>

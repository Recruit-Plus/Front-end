...
const [open, setOpen] = React.useState(false);
  ...
  return (
    ...
    <Item>
      ...
      <Box 
        style={{width:'90%',border:'2px solid black',height:'75%',backgroundColor:'#f8f8f8',margin:'0.6rem auto 0 auto',paddingLeft:30,paddingRight:3,paddingBottom:3,paddingTop:10}}>
        <Grid container>
        <Grid item xs={2} >
        <Container >
          <Stack>
